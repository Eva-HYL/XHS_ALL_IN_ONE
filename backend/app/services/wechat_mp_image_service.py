...
def generate_asset_for_prompt(
    ...
    from backend.app.services.wechat_mp_image_prompt_service import ensure_prompt_visual_plan

    ensure_prompt_visual_plan(article=article, section=section, prompt=prompt)
